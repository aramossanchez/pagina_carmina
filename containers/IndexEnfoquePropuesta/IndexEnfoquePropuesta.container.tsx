  ...
  return (
    <section id='Enfoque' className='w-full relative'>
      ...
      <div className='w-full py-10 bg-primaryColor1 flex flex-row justify-center text-textColor1'>
        <TitleComponent title='CÓMO PUEDO AYUDARTE' /> 
      </div>
    </section>
  )
}